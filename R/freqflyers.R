...
frqfls <- function(Plot_dir_name = "plot", Plot_file_name = "freq_flyers_l6_mod", Plot_width = 20, Plot_height = 11){

# load the design
freqflyers <- read.table("p16al7_50mz.freqflyers", quote = "\"", header = TRUE, sep = "\t", stringsAsFactors = FALSE, comment.char = "")
df <- freqflyers
df$Mz.diff <- df$Mz
